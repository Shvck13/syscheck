...
Me interesa especialmente todo lo que tiene que ver con ciberseguridad defensiva, administración de sistemas Linux y, más a largo plazo, neurotecnología aplicada a la informática. Tengo mucho por aprender todavía, pero avanzo con constancia.

---

## En qué estoy trabajando ahora mismo

- Profundizando en hardening de sistemas Linux y configuración segura de SSH
- Practicando scripting en Python y Bash para tareas de sysadmin
- Preparando el salto a Ingeniería Informática en la UAH
...
```
Python · Bash · Linux · HTML · Git
Redes (TCP/IP, DNS, DHCP, VLANs) · Virtualización (VMware, VirtualBox)
```
...
[LinkedIn](https://www.linkedin.com/in/sergiov-shvck13/) — si quieres hablar de proyectos, colaboraciones o simplemente tienes curiosidad por algo que he subido, estoy por aquí.
